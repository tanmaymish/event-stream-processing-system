 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-8.4.0-0-standalone.jar io.confluent.examples.streams.GlobalKTablesExample
 * }
 * </pre>
 ...
 * # all EnrichedOrders
 * $ java -cp target/kafka-streams-examples-8.4.0-0-standalone.jar io.confluent.examples.streams.GlobalKTablesAndStoresExampleDriver
 * }
 * </pre>
 * <p>
